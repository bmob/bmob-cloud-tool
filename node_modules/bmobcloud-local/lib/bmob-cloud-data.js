var CRequest = require("./../bmob-cloud-common").Request;
...
module.exports = (function () {
    ...
    model.setHeader = function (key, value) {
        if (key == "x-bmob-session-token") {
            model._SessionToken = value;
        } else if (key == "X-Bmob-Master-Key") {
            // db._MasterKey = value;
            Bmob.masterKey = value;
        }
    }
    ...
    model.userSignUp = function (request, callback) {
        __Request("users", "_User", null, "POST", request.data, callback);
    }
    ...
    model.userLogin = function (request, callback) {
        __Request("users", "_User", null, "GET", request, callback);
    }
    ...
    model.userRestPassword = function (request, callback) {
        __Request("requestPasswordReset", null, null, "POST", request.data, callback);
    }
    ...
    model.getUserByObjectId = function (request, callback) {
        __Request("users", "_User", request.objectId, "GET", null, callback);
    }
    ...
    model.updateUserByObjectId = function (request, callback) {
        __Request("users", "_User", request.objectId, "GET", request.data, callback);
    }
    ...
    model.getAllUser = function (request, callback) {
        __Request("users", "_User", null, "GET", null, callback);
    }
    ...
    model.removeUserByObjectId = function (request, callback) {
        __Request("users", "_User", request.objectId, "DELETE", null, callback);
    }
    ...
    model.requestEmailVerify = function (request, callback) {
        __Request("requestEmailVerify", null, null, "POST", request.data, callback);
    }
